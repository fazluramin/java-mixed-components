...
public class FrameComboListener extends JFrame 
{
	...
	public FrameComboListener() 
	{
		...
		btnRefresh.setIcon(new ImageIcon("/AutoCombo/Refresh.png"));
		...
		lblIco = new JLabel("");
		lblIco.setIcon(new ImageIcon("/AutoCombo/Pesawat.png"));
		lblIco.setBounds(388, 104, 196, 166);
		contentPane.add(lblIco);
		
		lblBg = new JLabel("");
		lblBg.setIcon(new ImageIcon("/AutoCombo/AirWallpaper.png"));
